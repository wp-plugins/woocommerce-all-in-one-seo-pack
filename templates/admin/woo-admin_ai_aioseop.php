		...
		<div class="options_group">
			<p class="form-field">
				...
				<input type="text" id="woo_ai_aioseop_title" name="aioseop_title" value="<?php echo $title; ?>" placeholder="" size="62"<?php disabled( $aioseop_enabled, false ); ?> />
				 <img class="help_tip" data-tip="<?php _e( 'Most search engines use a maximum of 60 chars for the title.', 'woo_ai' ); ?>" src="http://localhost/woocommerce/wp-content/plugins/woocommerce/assets/images/help.png" />
			</p>
			<p>
				...
				<textarea id="woo_ai_aioseop_description" name="aioseop_description" rows="3" cols="60"<?php disabled( $aioseop_enabled, false ); ?>><?php echo $description; ?></textarea>
				 <img class="help_tip" data-tip="<?php _e( 'Most search engines use a maximum of 160 chars for the description.', 'woo_ai' ); ?>" src="http://localhost/woocommerce/wp-content/plugins/woocommerce/assets/images/help.png" />
			</p>
			<p>
				...
				<input type="text" id="woo_ai_aioseop_keywords" name="aioseop_keywords" value="<?php echo $keywords; ?>" size="62"<?php disabled( $aioseop_enabled, false ); ?> />
				 <img class="help_tip" data-tip="<?php _e( 'Keywords are comma separated. For instance: clothes, mens, shirts, t-shirt, etc.', 'woo_ai' ); ?>" src="http://localhost/woocommerce/wp-content/plugins/woocommerce/assets/images/help.png" />
			</p>
			<p>
		...
		<div class="options_group">
			<p class="form-field">
				...
				<input type="checkbox" id="woo_ai_aioseop_disable" name="aioseop_disable" class="checkbox"<?php checked( $disable, 'on' ); ?><?php disabled( $aioseop_enabled, false ); ?> />
				 <img class="help_tip" data-tip="<?php _e( 'Disable on this Product.', 'woo_ai' ); ?>" src="http://localhost/woocommerce/wp-content/plugins/woocommerce/assets/images/help.png" />
			</p>
		</div>
	</div>
</div>